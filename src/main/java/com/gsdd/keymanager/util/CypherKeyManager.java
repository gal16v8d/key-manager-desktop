...
public final class CypherKeyManager {
  ...
  public static String encodeKM(String data) {
    return CypherUtil.encode(data, KM_SALT, DigestAlgorithm.SHA512,
        CypherAlgorithm.AES_WITH_PADDING);
  }

  public static String decodeKM(String data) {
    return CypherUtil.decode(data, KM_SALT, DigestAlgorithm.SHA512,
        CypherAlgorithm.AES_WITH_PADDING);
  }
