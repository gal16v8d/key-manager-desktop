...
public class UsuarioView extends AbstractCrudView {
  ...
  private void initLabels() {
    ...
    addLabel(KeyManagerLanguage.getMessageByLocale(KeyManagerLanguage.LABEL_U_FN), INI_X_LABEL_C1,
        POS_Y_ROW_1);
    addLabel(KeyManagerLanguage.getMessageByLocale(KeyManagerLanguage.LABEL_U_LN), INI_X_LABEL_C2,
        POS_Y_ROW_1);
    addLabel(KeyManagerLanguage.getMessageByLocale(KeyManagerLanguage.LABEL_U_USER), INI_X_LABEL_C1,
        POS_Y_ROW_2);
    addLabel(KeyManagerLanguage.getMessageByLocale(KeyManagerLanguage.LABEL_U_PASS), INI_X_LABEL_C2,
        POS_Y_ROW_2);
    addLabel(KeyManagerLanguage.getMessageByLocale(KeyManagerLanguage.LABEL_U_ROLE), INI_X_LABEL_C1,
        POS_Y_ROW_3);
  }
