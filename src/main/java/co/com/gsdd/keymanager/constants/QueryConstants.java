...
public final class QueryConstants {
    ...
    private static final String USER_SELECT = "SELECT codigousuario, primer_nombre, primer_apellido, username, password, rol ";
    ...
    public static final String USER_LIST_ADMIN = USER_SELECT
    ...
    public static final String ACCOUNTXUSER_UPDATE = "UPDATE cuentaxusuario SET nombrecuenta = ?, codigousuario = ?, "
            + "username = ?, password = ?, url = ?, fecha = ? WHERE nombrecuenta = ? AND codigousuario = ?";
    private static final String ACCOUNTXUSER_SELECT = "SELECT cxu.codigousuario, cxu.nombrecuenta, u.username, cxu.url, "
            + "cxu.username, cxu.password, cxu.fecha "
            + "FROM cuentaxusuario cxu JOIN usuario u ON (u.codigousuario = cxu.codigousuario) ";
    public static final String ACCOUNTXUSER_LIST = ACCOUNTXUSER_SELECT
            + "WHERE u.codigousuario = ? ORDER BY u.username,cxu.nombrecuenta";
    public static final String ACCOUNTXUSER_LIST_ADMIN = ACCOUNTXUSER_SELECT + "ORDER BY u.username,cxu.nombrecuenta";
    public static final String ACCOUNTXUSER_SEARCH = ACCOUNTXUSER_SELECT
            + "WHERE cxu.nombrecuenta = ? AND cxu.codigousuario = ?";
