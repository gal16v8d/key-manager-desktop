...
ALTER TABLE ACCOUNT_LOGIN ADD CONSTRAINT FK_ACCOUNT FOREIGN KEY (account_id) REFERENCES ACCOUNT (account_id) ON DELETE CASCADE;
ALTER TABLE ACCOUNT_LOGIN ADD CONSTRAINT FK_ACCOUNT_TYPE FOREIGN KEY (type_id) REFERENCES ACCOUNT_TYPE (type_id);
